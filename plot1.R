...
# Plot is histogram of Global Active Power value
...
#create the histogram and copy to file
par(mfrow = c(1, 1))
hist(d1$Global_active_power, main = "Global Active Power", xlab = "Global Active Power (kilowatts)", ylab = "Frequency", col = "red")
